...
var c=a.source,d=a.compile;c&&(ka(b,c),d&&(la(b),ra(b,Ca)||l(new F(b,Sa(b),c),a)));e(a.M,function(a){fa(X(a)===Ra?a:H(a),b)},sa);p(b,a);return b}function U(a,b){if("object"!==typeof b||!b)throw new TypeError("Parameter 'descriptor' must be an object.");var d=b.bind,e=b.target,f=b.data;f===y&&(f=b.size);d&&ma(e,a);f&&na(c,f,b.usage);return e}if(!Ta(this))return new O(c);if(!(c instanceof wa))throw new TypeError("Parameter 'gl' must be a WebGLRenderingContext.");var P=this,m=f(P),V=Kb(c),ha=Lb(c),Y=
Mb(c),ia=Nb(c),ja=Ob(c),ka=Ja(c),la=Ia(c),fa=ya(c),Z=za(c),ma=Ka(c),na=La(c),aa=Pb(c),Pa=Aa(c),Qa=Ba(c),ra=Da(c),Sa=Ea(c);(function(a){b(u,a,"_program_util_");d(a)})(h(ta));(function(a){b(t,a,"_variable_util_");d(a)})(h(Ua));(function(a){b(r,a,"_shader_util_");d(a)})(h(Va));var Na=function(a){b(v,a,"_fragment_shader_util_");return a}(new r(null)),Oa=function(a){b(C,a,"_vertex_shader_util_");return a}(new r(null));(function(a){b(D,a,"_buffer_util_");d(a)})(h(Wa));(function(a){b(A,a,"_gl_error_");d(a)})(h(ua));
